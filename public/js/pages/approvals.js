...
export default async function render(root, { setTitle, can, params, me, roleLabel }) {
  ...
  async function open(id) {
    const a = await get('/api/approvals/' + id); // server can_act / is_mine qaytaradi (o'z so'rovini tasdiqlab bo'lmaydi)
    const canAct = !!a.can_act;
