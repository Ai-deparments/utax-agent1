...
export default async function render(root, { setTitle, can }) {
  ...
  const body = h('div', {});
  const AD_ICON = { BANK_API: 'bank', GOOGLE_SHEETS: 'file', EXCEL: 'upload', ONE_C: 'layers', ERP: 'briefcase', TELEGRAM: 'send', EMAIL: 'inbox', GEMINI: 'sparkles', GROQ: 'zap', WEBHOOK_IN: 'link' };
  async function load() {
