...
export const IGNORE_LABEL = { LOAN: 'Kredit / ta’sischi mablag‘i', REFUND: 'Qaytarilgan mablag‘', INTEREST: 'Bank foizlari', OTHER_INCOME: 'Boshqa kirim', OTHER: 'Boshqa', REVERSAL: 'Tuzatish yozuvi', NON_CONTRACT: 'Shartnomasiz', PAYROLL: 'Oylik', TRANSFER: 'Ichki o‘tkazma (bank ↔ kassa)', DIVIDEND: 'Dividend' };
