/**
 * ⚠️ FAQAT TESTLAR UCHUN (test fixture). Bu ma'lumotlar TO'QIMA — haqiqiy bazaga HECH QACHON yuklanmaydi.
 * Haqiqiy ma'lumot faqat Excel importi orqali kiradi (src/import/ledger-journal.mjs). Qoida: CLAUDE.md.
 * DEMO DATA — Iyul 2026 (+ iyun tarix, avgust, sentabr). Voqealar xronologik qo'llanadi,
...
import { nowIso, today, round2 } from '../../src/core/util.mjs';
...
export async function seed(app, { log = console.log } = {}) {
  ...
  // test sozlamalari (production'da default 0 / bo'sh)
  app.settings.set('cash.safety_reserve', 50000000); app.settings.set('cash.low_liquidity_threshold', 100000000); app.settings.set('fx.rates', { USD: 12700, EUR: 13800, RUB: 140 });
